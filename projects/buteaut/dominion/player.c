...
int main2(int argc, char *argv[]) {
	...
	int k[10] = {adventurer, gardens, embargo, village, remodel, mine, cutpurse, sea_hag, tribute, smithy};
	struct gameState g;
...
int main(int argc, char* argv[]) {
	...
	//Default cards, as defined in playDom
	int kCards[10] = {adventurer, gardens, embargo, village, remodel, mine, cutpurse, sea_hag, tribute, smithy};
