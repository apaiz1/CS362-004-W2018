...
* 4 Feb 2018
* ******************************************************
* First Test of Dominion card: Great Hall 
* *******************************************************
...
int main() {
    ...
    int other_player = 1;
    /*
    * The great hall card does not have any options. So it will stay the same
    * for this game.
    */
    int choice_1 = 0;
    int choice_2 = 0;
    ...
    */
    ...
    printf("numActions = %d, expected actions = %d", test_game.numActions, 
        reg_game.numActions + extra_action);
    /*
    assert(test_game.numActions == reg_game.numActions + extra_action);
    */
